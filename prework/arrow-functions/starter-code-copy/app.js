...
// 'this' refers to the instance of joe when joe.scope is invoked.
// 2. What is "this" when joe.scopeArrow() is invoked?
// 'this' refers to the global object? (window?) I think that's what I'm seeing on mdn
// 3. Explain why "this" is different when an arrow function is used.
// 'this' is different because an arrow function expression does not have its own bindings to 'this'.
