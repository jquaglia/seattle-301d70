...
function displayPics(){
  ...
  // The previous line of code threw an error because the variable `rando` was declared with `let` inside of a while loop code block. `let` is block scoped so when it was made inside of the code block, it could not be accessed outside the block even though it was in the same function.
  console.log(viewed);
